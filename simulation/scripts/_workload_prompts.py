...
* swebench / swebench_verified → ``data/swebench_verified/dataset_interleaved.jsonl``
  HF schema with ``problem_statement`` field.
...
WORKLOAD_FILES = {
    "specbench": "data/specbench/dataset.jsonl",
    "bfcl_v4": "data/bfcl_agent/dataset.jsonl",
    "swebench": "data/swebench_verified/dataset_interleaved.jsonl",
...
_EXTRACTORS = {
    ...
    "swebench_verified": _extract_swebench,
}
...
def load_workload_prompts(
    ...
    Missing dataset file → empty list + stderr warning.
    """
